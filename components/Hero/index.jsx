...
const slideImage = {
  id: 1,
  title: 'The best Levaboard of the Red Sea',
...
export default function Hero () {
  return (
    ...
    >
      ...
      <div className='container items-start text-left flex flex-wrap  pt-20'>
        <div className='-mx-4  flex flex-wrap'>
          <div className='w-full items-start text-left  px-8 sm:px-20 pt-20'>
            <div
              className='wow items-start text-left   fadeInUp mx-auto max-w-[800px] text-white dark:text-white '
              data-wow-delay='.2s'
            >
              <h1 className='   drob-shadows max-w-xl mb-5 text-2xl font-bold leading-tight text-white dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight'>
                {slideImage?.title}
              </h1>
