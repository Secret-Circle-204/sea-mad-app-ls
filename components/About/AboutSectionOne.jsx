              ...
              >
                <div className="mx-[-12px] flex flex-wrap">
                  <div className="w-full px-3 sm:w-1/2 lg:w-full xl:w-1/2">
                    <List text="Diving safari to the Highlights" />
                    <List text="Professional Dive Team" />
                    <List text="“NITROX FOR FREE”" />
                    <List text="Rebreather Friendly" />
                    <List text="Rescue Radios on board" />
                    <List text="Kite Safaris" />
